...
def test_uglify():
    ...
    for i in trange(100, leave=False):
        ...
        for j in trange(3, leave=False):
            ...
            ugly1 = uglify(csv_inner, seed=i, satellite_artefacts=True)
            ugly2 = uglify(csv_inner, seed=i, satellite_artefacts=True)
...
def test_loading_csv_from_path():
    ...
    for i in trange(100, leave=False):
        ...
        for j in trange(3, leave=False):
            ...
            ugly1 = uglify("test.csv", seed=i, satellite_artefacts=True)
            ugly2 = uglify("test.csv", seed=i, satellite_artefacts=True)
